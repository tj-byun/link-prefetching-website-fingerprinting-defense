...
Link prefetching is a HTML syntax that gives the web browser hints about which page the user is most likely to visit in the near future~\cite{fisher2003, fisher2004link}. 
