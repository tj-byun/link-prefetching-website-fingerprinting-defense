...
data_pf_off=load(pf_off_file);
data_pf_on=load(pf_on_file);
  ...
  a=3;
    ...
    for iteration=1:max_iter
    	[pf_off_tr_l,pf_off_tr,pf_off_te_l,pf_off_te]= ...
			get_dir_data(data_pf_off,max_c,training_fraction);
    	[pf_on_tr_l,pf_on_tr,pf_on_te_l,pf_on_te]=get_dir_data(data_pf_on,max_c,training_fraction);
    	data_tr=[];
    	data_te=[];
